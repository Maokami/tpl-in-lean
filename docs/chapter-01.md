...
| **1.5** (a)~(d) | 합 식 `Σ v : e₀ to e₁. e₂` 추가: 문법·의미·FV·치환·추론 규칙 | ★★★ | 자족 파일 `Ex/Summation.lean`에 축소판 언어로 |
| **1.6** | 부정합(indefinite) 합 `Σv. e` 의 문제점 논의 | ★★ | Verso 산문 + 문제가 드러나는 Lean 반례 |
