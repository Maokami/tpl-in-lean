...
6. `Substitution.lean` — §1.4 치환, 명제 1.2~1.5
7. `Depth/Algebra.lean` — 심화 A (선택). 대수와 초기성
8. `Depth/SignatureFunctor.lean` — 심화 B (선택). 시그니처 함자와 Lambek
9. `Depth/TermMonad.lean` — 심화 A (선택). 치환은 bind 다
-/
